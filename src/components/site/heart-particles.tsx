...
const hearts: { left: number; size: number; delay: number; duration: number; opacity: number }[] = [
	{ left: 4, size: 12, delay: 0, duration: 26, opacity: 0.75 },
	{ left: 13, size: 8, delay: 7, duration: 32, opacity: 0.6 },
	{ left: 22, size: 14, delay: 15, duration: 24, opacity: 0.7 },
	{ left: 31, size: 9, delay: 3, duration: 30, opacity: 0.55 },
	{ left: 40, size: 11, delay: 19, duration: 28, opacity: 0.7 },
	{ left: 49, size: 8, delay: 11, duration: 34, opacity: 0.6 },
	{ left: 58, size: 13, delay: 22, duration: 25, opacity: 0.75 },
	{ left: 67, size: 9, delay: 5, duration: 31, opacity: 0.55 },
	{ left: 76, size: 12, delay: 13, duration: 27, opacity: 0.7 },
	{ left: 85, size: 8, delay: 25, duration: 33, opacity: 0.6 },
	{ left: 93, size: 11, delay: 9, duration: 29, opacity: 0.7 },
];
